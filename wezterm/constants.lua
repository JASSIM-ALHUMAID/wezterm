...
return {
	...
	-- All themed colors live in theme.lua.
	-- Linux:  generated by ~/.config/caelestia/scripts/wezterm-theme.py
	-- Windows: generated by ~/.config/yasb/colorScheme.ps1 from theme.lua.template
	theme = theme,
